...
struct Operator : public Object {
  ...
  Object *operator()(std::list<Object *> arg_list, interp::LocalRuntime &r,
                     interp::LexicalScope &s, bool macexpand = false);
  virtual Object *call(std::list<Object *> arg_list, interp::LocalRuntime &r,
                       interp::LexicalScope &s, bool macexpand = false) = 0;
  std::list<Object *> get_arg_list(Object *arg_list, interp::LocalRuntime &r,
...
struct UserOperator : public Operator {
  ...
  UserOperator(std::list<Object *> op_def, bool eval_args,
               interp::LocalRuntime &r, interp::LexicalScope &s);
};
...
struct InbuiltOperator : public Operator {
  ...
  InbuiltOperator(std::string name, std::string str,
                  Object *(*call)(std::list<Object *> arg_list,
  ...
  // STATE
  Object *(*fnc)(std::list<Object *> arg_list, interp::LocalRuntime &r,
                 interp::LexicalScope &s);
};

struct NextFnc : public Operator {
  // FUNCTIONS
  NextFnc(std::list<Operator *> funcs, std::list<Object *> arg_list,
          Symbol *nextsym);
  Object *call(std::list<Object *> arg_list, interp::LocalRuntime &r,
               interp::LexicalScope &s, bool macexpand = false);
