...
Value *op_str_elt(Operator* op, Value *alist, LocalRuntime &r, LexicalScope &s) {
...
Value *op_str_cat(Operator* op, Value *alist, LocalRuntime &r, LexicalScope &s) {
  list<Value *> arg_list = op->get_arg_list(alist, r, s);
  string str;
...
Value *op_str_gr(Operator* op, Value *alist, LocalRuntime &r, LexicalScope &s) {
  list<Value *> arg_list = op->get_arg_list(alist, r, s);
